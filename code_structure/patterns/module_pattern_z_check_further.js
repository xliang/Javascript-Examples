...
Pros
    ...
    Smaller memory footprint. Anything attached to the constructor's prototype is shared, 
    not duplicated, across instances. This means one instance's getName is the same function 
    as another instance's getName. This is because of the prototype chain (think of it as inheritance chain), where instances "inherit" the same object.
