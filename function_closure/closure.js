...
/*
    ...
    Closures to the rescue! Remember, a closure is created by taking a function that has access to a variable in the current execution context
    and saving it to a variable outside of the current execution context. 
